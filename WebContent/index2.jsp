...
<body>
    <div class="container">
        <div class="row">
            <div class="text">
                <p class="text T"><a href="index.jsp">main</a></p>
                <p class="text B"><a href="plan/plan.jsp">plan</a></p>
                <p class="text R"><a href="video/video.jsp">video</a></p>
                <p class="text L"><a href="calendar/calendar_side.jsp">calendar</a></p>
            </div>
            <div id="TopLogin">
                <ul id="TopUl">  
                    <li><a href="#" id="TopR2">마이페이지</a></li>
                    <li><a href="index.jsp" id="TopR1">로그아웃</a></li>
                </ul>
            </div>
            <div class="row">
